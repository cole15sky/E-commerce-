<template>
    <div>
      <!-- fetched data yeha display hunxa -->
      <div v-if="products.length">
        <div v-for="product in products" :key="product.id" class="mt-20 w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          <a href="#">
            <img
          ...
          <div class="px-5 pb-5">
            ...
            <div class="flex items-center mt-2.5 mb-5">
              <div class="flex items-center space-x-1 rtl:space-x-reverse">
                <!-- Star ratings -->
                <svg class="w-5 h-5 text-yellow-400" aria-hidden="true" fill="currentColor" viewBox="0 0 22 20">
