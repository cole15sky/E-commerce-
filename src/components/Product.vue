<template>
  <div>
    <div
      ...
      class="grid grid-cols-1 sm:grid-cols-5 lg:grid-cols-4 gap-8 mt-20"
    >
      <div 
      ...
      >
        {{ console.log(`Image for product id ${product.id} is ${product.images[0]}`) }}
        <a href="#">
          <img
...
const getImage = (imagePath) => {
  if (imagePath.includes('[') || imagePath.includes(']') || !imagePath) {
    return DefaultImage;
  } else {
    return imagePath;
  }
...
// Compute a list of products with valid image URLs
